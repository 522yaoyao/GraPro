...
<%@page import="ly.decisiontree.TestSet" %> 
...
String processedTrain = "D://datamining//tree//process//adultResult.txt";
String processedTest = "D://datamining//tree//process//adultTestResult.txt";
String tmpFile="D://datamining//tree//tmp.txt";//存储中间结果的文件
...
wrong_number=testList.size()-TestSet.lastRs(processedTest);
//System.out.println(TestSet.lastRs(processedTest));
//存入数据集条数
...
<form action="dstree.jsp" method="post"  > 
<div class="div1" >
<div class="center">
<div class="first" id="first">
<p align="center">请选择合适的数据集：</p>
<input type="radio" name="train" value="D://datamining//tree//file//adult2000.data">训练集2000条<br>
<input type="radio" name="train" value="D://datamining//tree//file//adult5000.data">训练集5000条<br>
<input type="radio" name="train" value="D://datamining//tree//file//adult7500.data">训练集7500条<br>
<input type="radio" name="train" value="D://datamining//tree//file//adult10000.data">训练集10000条<br>
<input type="radio" name="train" value="D://datamining//tree//file//adult20000.data">训练集20000条<br>
<input type="radio" name="train"  value="D://datamining//tree//file//adult32561.data">训练集38000条<br>
<div class="bottom">
...
<input type="radio" name="test"  value="D://datamining//tree//file//adult100.test"  checked="checked">测试集100条<br>
<input type="radio" name="test" value="D://datamining//tree//file//adult1000.test">测试集1000条<br>
<p></p>
<br>
<div class="bottom">
